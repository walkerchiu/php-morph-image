        ...
        $validator->after(function ($validator) {
            ...
            if (isset($data['host_type']) && isset($data['host_id'])) {
                if ( config('wk-morph-image.onoff.blog') ) {
                    if ( !empty(config('wk-core.class.blog.article')) && $data['host_type'] == config('wk-core.class.blog.article') ) {
                    ...
                    } elseif ( !empty(config('wk-core.class.blog.blog')) && $data['host_type'] == config('wk-core.class.blog.blog') ) {
                        $result = DB::table(config('wk-core.table.blog.blogs'))
                                    ->where('id', $data['host_id'])
                                    ->exists();
                        if (!$result)
                            $validator->errors()->add('host_id', trans('php-core::validation.exists'));
                    } elseif ( !empty(config('wk-core.class.blog.category')) && $data['host_type'] == config('wk-core.class.blog.category') ) {
                ...
                if ( config('wk-morph-image.onoff.site') && !empty(config('wk-core.class.site.site')) && $data['host_type'] == config('wk-core.class.site.site') ) {
                ...
                if ( config('wk-morph-image.onoff.group') && !empty(config('wk-core.class.group.group')) && $data['host_type'] == config('wk-core.class.group.group') ) {
                ...
                if ( config('wk-morph-image.onoff.morph-category') && !empty(config('wk-core.class.morph-category.category')) && $data['host_type'] == config('wk-core.class.morph-category.category') ) {
            ...
            if (isset($data['morph_type']) && isset($data['morph_id'])) {
                if ( config('wk-morph-image.onoff.blog') ) {
                    if ( !empty(config('wk-core.class.blog.article')) && $data['morph_type'] == config('wk-core.class.blog.article') ) {
                        $result = DB::table(config('wk-core.table.blog.articles'))
                                    ->where('id', $data['morph_id'])
                                    ->exists();
                        if (!$result)
                            $validator->errors()->add('morph_id', trans('php-core::validation.exists'));
                    } elseif ( !empty(config('wk-core.class.blog.blog')) && $data['morph_type'] == config('wk-core.class.blog.blog') ) {
                        $result = DB::table(config('wk-core.table.blog.blogs'))
                                    ->where('id', $data['morph_id'])
                                    ->exists();
                        if (!$result)
                            $validator->errors()->add('morph_id', trans('php-core::validation.exists'));
                    } elseif ( !empty(config('wk-core.class.blog.category')) && $data['morph_type'] == config('wk-core.class.blog.category') ) {
                        $result = DB::table(config('wk-core.table.blog.categories'))
                                    ->where('id', $data['morph_id'])
                                    ->exists();
                        if (!$result)
                ...
                if ( config('wk-morph-image.onoff.site') && !empty(config('wk-core.class.site.site')) && $data['morph_type'] == config('wk-core.class.site.site') ) {
                    $result = DB::table(config('wk-core.table.site.sites'))
                                ->where('id', $data['morph_id'])
                                ->exists();
                    if (!$result)
                ...
                if ( config('wk-morph-image.onoff.group') && !empty(config('wk-core.class.group.group')) && $data['morph_type'] == config('wk-core.class.group.group') ) {
                    $result = DB::table(config('wk-core.table.group.groups'))
                                ->where('id', $data['morph_id'])
                                ->exists();
                    if (!$result)
                ...
                if ( config('wk-morph-image.onoff.morph-category') && !empty(config('wk-core.class.morph-category.category')) && $data['morph_type'] == config('wk-core.class.morph-category.category') ) {
                    $result = DB::table(config('wk-core.table.morph-category.categories'))
                                ->where('id', $data['morph_id'])
                                ->exists();
                    if (!$result)
                ...
                if ( config('wk-morph-image.onoff.mall-shelf') ) {
                    if ( !empty(config('wk-core.class.mall-shelf.catalog')) && $data['morph_type'] == config('wk-core.class.mall-shelf.catalog') ) {
                        $result = DB::table(config('wk-core.table.mall-shelf.catalogs'))
                                    ->where('id', $data['morph_id'])
                                    ->exists();
                        if (!$result)
                            $validator->errors()->add('morph_id', trans('php-core::validation.exists'));
                    } elseif ( !empty(config('wk-core.class.mall-shelf.product')) && $data['morph_type'] == config('wk-core.class.mall-shelf.product') ) {
                    ...
                    } elseif ( !empty(config('wk-core.class.mall-shelf.stock')) && $data['morph_type'] == config('wk-core.class.mall-shelf.stock') ) {
